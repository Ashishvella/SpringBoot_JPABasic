...
public class AccountController {
	...
	@ResponseBody
	public ResponseEntity<Account> getAccountByAccountNumber(@PathVariable("acctNumber") Long accountNumber)
			throws ResourceNotFoundException {
		Account account = null;
		account=accountService.getAccountDetails(accountNumber);
		if (account == null) {
